...
safe_int_array::safe_int_array(std::initializer_list<int> ilist) :
  size(ilist.size()), values(new int[ilist.size()])
{
  std::cout<<"in ilist constructor"<<std::endl;
