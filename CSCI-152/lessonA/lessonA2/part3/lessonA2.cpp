...
int main()
{
  ...
  output_state(my_car);
  /*
  The code below works, because the car in car.h is declared as struct,
  so it is possible to directly access and modify variable values.
  */
  my_car.engine_on = false;
  my_car.speed = 1989.0302;
